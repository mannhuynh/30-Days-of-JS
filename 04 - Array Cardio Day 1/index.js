...
const filter = inventors.filter(function (elem) {
	return `${elem.first}`;
});
console.log(filter);
...
// //NOTE: first get links from anchor tag inside the category
// const category = document.querySelector('.mw-category');
// const links = Array.from(document.querySelectorAll('a'));

// //NOTE: map the textContent from the links and filter the street name include 'de'
